...
<!--Titulo-->
	...
	<!--Contraseña-->
	<div>
			<p class="subtitulos" style="position: absolute; top:40%; left:41%; font-size: 1.55em;">Contraseña</p>	
	</div>
...
<br/>
<input type="text" style="position: absolute; width: 20%; height: 50px; top: 48%; left: 40%;" placeholder="Contraseña" name="pw" id="pw" value=<%=pw %>>
<br/>
